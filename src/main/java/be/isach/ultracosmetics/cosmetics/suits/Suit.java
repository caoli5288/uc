...
public class Suit {
    ...
    public Suit(final UUID owner, ArmorSlot armorSlot, SuitType suitType) {
        ...
        getPlayer().sendMessage(MessageManager.getMessage("Suits.Equip").replace("%suitname%", (Main.getInstance().placeholdersHaveColor())
                ? getType().getName(getArmorSlot()) : Main.filterColor(getType().getName(getArmorSlot()))));
    }
    ...
    public UltraPlayer getCustomPlayer() {
        return Main.getPlayerManager().getUltraPlayer(getPlayer());
    }
    ...
    public void clear() {
        ...
        if (getPlayer() != null)
            getPlayer().sendMessage(MessageManager.getMessage("Suits.Unequip").replace("%suitname%", (Main.getInstance().placeholdersHaveColor())
                    ? getType().getName(getArmorSlot()) : Main.filterColor(getType().getName(getArmorSlot()))));
        owner = null;
        armorSlot = null;
        suitType = null;
