...
public enum MorphType {
    ...
    ELDERGUARDIAN("ultracosmetics.morphs.elderguardian", "ElderGuardian", Material.PRISMARINE_CRYSTALS, (byte) 0, DisguiseType.valueOf("ELDER_GUARDIAN"), "&7&oBecome an Elder Guardian!!", Main.getInstance().getMorphs().getElderGuardianClass());
    ...
    public boolean isEnabled() {
        if(Main.getServerVersion().compareTo(ServerVersion.v1_9_R1) >= 0 && this == ELDERGUARDIAN) return false;
