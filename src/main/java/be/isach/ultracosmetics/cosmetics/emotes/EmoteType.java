...
public class EmoteType {
    ...
    public EmoteType(String permission, String configName, String defaultDesc, int ticksPerFrame) {
        ...
        if (SettingsManager.getConfig().get("Emotes." + configName + ".Description") == null) {
            ...
            Main.config.addDefault("Emotes." + configName + ".Description", getDescriptionColored(), "description of this emote.");
        } else {
    ...
    public Emote equip(Player player) {
        if (player.getInventory().getHelmet() != null) {
            if (Main.getUltraPlayer(player).currentHat != null) {
                Main.getUltraPlayer(player).removeHat();
            } else if (Main.getUltraPlayer(player).currentEmote != null) {
                Main.getUltraPlayer(player).removeEmote();
            } else {
