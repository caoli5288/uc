...
public abstract class CustomEntityPet extends Pet {
    ...
    public void equip() {
            ...
            public void run() {
                try {
                    ...
                    if (Bukkit.getPlayer(getOwner()) != null
                            && Main.getUltraPlayer(Bukkit.getPlayer(getOwner())).currentPet != null
                            && Main.getUltraPlayer(Bukkit.getPlayer(getOwner())).currentPet.getType() == getType()) {
        ...
        ((org.bukkit.craftbukkit.v1_10_R1.CraftWorld) getPlayer().getWorld()).getHandle()
