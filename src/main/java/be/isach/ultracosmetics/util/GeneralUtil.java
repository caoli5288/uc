...
public class GeneralUtil {
    ...
    public static void printPermissions() {
        ...
        try {
            writer = new PrintWriter(new File(Main.getInstance().getDataFolder(), "permissions.yml"), "UTF-8");
        ...
        writer.println();
        writer.println("UltraCosmetics v" + Main.currentVersion + " permissions.");
        ...
        for (SubCommand subCommand : Main.getInstance().getCommandManager().commands)
